...
model.load_state_dict(torch.load('/home/harshubh/Desktop/SRCNN/outputs/model.pth'))
...
for image_path in image_paths:
    ...
    cv2.imwrite(f"/home/harshubh/Desktop/SRCNN/outputs/test_{test_image_name}.png", image)
    ...
    with torch.no_grad():
        ...
        outputs = model(image)
    outputs = outputs.cpu()
    save_image(outputs, f"/home/harshubh/Desktop/SRCNN/outputs/output_{test_image_name}.png")
